...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES bash sshpass  python3-light parted kmod-tun ethtool lm-sensors iperf3 htop luci-app-vlmcsd luci-i18n-vlmcsd-zh-cn luci-app-xupnpd luci-i18n-xupnpd-zh-cn"
